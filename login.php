        ...
        <div class="form-section">
            ...
            <form method="POST" action="login.php">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        <span class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lock" viewBox="0 0 16 16"><path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 0V4s0 .5-.245.78-.564.42-.945.42.5-.245.78-.564.42-.945.42-.945V1a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1v2.5a.5.5 0 0 1-1 0V1a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2zM3.5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-2zM2 11.5a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-9a2 2 0 0 1-2-2v-2z"/></svg></span>
